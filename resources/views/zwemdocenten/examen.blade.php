        ...
        <div class="w-full">
            <div class=" bg-gray-100 flex justify-center items-center">
                <div class="container mx-auto rounded-lg px-14 py-8">
                    <form method="GET" action="{{ route('eindexamen.index') }}">
                        <h1 class="text-center font-bold text-gray-700 my-6 text-4xl">Eindexamen</h1>
                        <div class="sm:flex items-center bg-white rounded-lg overflow-hidden px-2 py-1 justify-between">
                            <input
                                ...
                                type="text" name="search" placeholder="Zoek naar Eindexamen"
            ...
            <div class="w-full">
                <div class="flex flex-wrap">
                    @foreach ($eindexamen as $eindexam)
                        <div
                            ...
                            <div class="flex items-center justify-between gap-4 mb-2">
                                <a class="relative inline-block object-cover object-center rounded-full font-medium">
                                    {{ $eindexam->examen_naam }}
                                </a>
                                <a href="{{ route('eindexamen.show', $eindexam) }}"
